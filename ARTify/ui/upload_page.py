...
class UploadPage(QWidget):
    ...
    def initUI(self):
        ...
        self.upload_new_button.setFont(QFont("Arial", 14))
        ...
        self.select_sample_button.setFont(QFont("Arial", 14))
...
class CameraDialog(QDialog):
    ...
    def __init__(self, parent, camera_index_to_use):
        ...
        if len(self.camera_index_to_use) != 2:
            ...
            self.switch_camera_button.setStyleSheet(disabled_button_style)
...
class ProgressBarPage(QWidget):
    ...
    def show_loading_overlay(self, my_sizing):
        ...
        self.progress_bar.setFixedSize(int(my_sizing[0] * 0.6), int(my_sizing[0] * 0.05))
        self.progress_bar.move((my_sizing[0] - self.progress_bar.width()) // 2, my_sizing[1] // 2 - int(my_sizing[0]*0.05)//2)
